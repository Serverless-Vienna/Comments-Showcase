...
export default class AwsUtil {
    ...
    static obtainAWSCredentials(that) {
    ...
    static resetAWSLogin() {
        ...
        AWS.config.credentials = new AWS.CognitoIdentityCredentials({IdentityPoolId: APPCONFIG.AWS.COGNITO.IDENTITY_POOL_ID});
        // Initialize the Amazon Cognito credentials provider
        AWS.config.update({region: APPCONFIG.AWS.REGION});
    }
}
